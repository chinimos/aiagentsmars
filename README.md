...
idle and walk cycles (Claude the SwordMan, Averis the ArchMage, Suni the
Princess, Yenna the HalberdMan, Atlas the Worker; knights and mages on the
road). Monsters are the **Tiny RPG Orc** with real walk/attack/death
